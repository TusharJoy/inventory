            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form
                            @submit.prevent="
                                form.put(route('crops.update', crop.crop_id))
                            "
                            class="space-y-6"
                        >
                            <div>
...
const form = useForm({
    batch_id: props.crop.batch_id,
    crop_name: props.crop.crop_name,
    crop_type: props.crop.crop_type,
    crop_variety: props.crop.crop_variety,
    growing_season: props.crop.growing_season,
    planting_date: props.crop.planting_date,
    expected_harvest_date: props.crop.expected_harvest_date,
    actual_harvest_date: props.crop.actual_harvest_date,
    yield_amount: props.crop.yield_amount,
    yield_unit: props.crop.yield_unit,
    crop_status: props.crop.crop_status,
